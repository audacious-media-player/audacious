...
gboolean vfs_fget_le16 (uint16_t * value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fget_le32 (uint32_t * value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fget_le64 (uint64_t * value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fget_be16 (uint16_t * value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fget_be32 (uint32_t * value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fget_be64 (uint64_t * value, VFSFile * stream) WARN_RETURN;

gboolean vfs_fput_le16 (uint16_t value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fput_le32 (uint32_t value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fput_le64 (uint64_t value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fput_be16 (uint16_t value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fput_be32 (uint32_t value, VFSFile * stream) WARN_RETURN;
gboolean vfs_fput_be64 (uint64_t value, VFSFile * stream) WARN_RETURN;

gboolean vfs_is_streaming (VFSFile * file) WARN_RETURN;
char * vfs_get_metadata (VFSFile * file, const char * field) WARN_RETURN;

gboolean vfs_file_test (const char * path, GFileTest test) WARN_RETURN;
gboolean vfs_is_writeable (const char * path) WARN_RETURN;
gboolean vfs_is_remote (const char * path) WARN_RETURN;
