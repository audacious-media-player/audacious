      ...
      for (j=0;j<stereo;j++)
      {
        if ( (ba=*bita++) ) 
        {
          ...
          if( (d1=alloc2->d) < 0) 
          {
            ...
            fraction[j][0][i] = ((real) ((int)mpg123_getbits(&bsi,k) + d1)) * cm;
            fraction[j][1][i] = ((real) ((int)mpg123_getbits(&bsi,k) + d1)) * cm;
            fraction[j][2][i] = ((real) ((int)mpg123_getbits(&bsi,k) + d1)) * cm;
          }        
          else 
          {
    ...
    for (i=jsbound;i<sblimit;i++,alloc1+=(1<<step))
    {
      ...
      if ( (ba=*bita++) )
      {
        ...
        if( (d1=alloc2->d) < 0)
        {
          ...
          fraction[1][0][i] = (fraction[0][0][i] = (real) ((int)mpg123_getbits(&bsi,k) + d1) ) * cm;
          fraction[1][1][i] = (fraction[0][1][i] = (real) ((int)mpg123_getbits(&bsi,k) + d1) ) * cm;
          fraction[1][2][i] = (fraction[0][2][i] = (real) ((int)mpg123_getbits(&bsi,k) + d1) ) * cm;
        ...
        else
        {
          ...
          idx = (unsigned int) mpg123_getbits(&bsi,k);
          tab = (unsigned int *) (table[d1] + idx + idx + idx);
          fraction[0][0][i] = mpg123_muls[*tab][m1]; fraction[1][0][i] = mpg123_muls[*tab++][m2];
          fraction[0][1][i] = mpg123_muls[*tab][m1]; fraction[1][1][i] = mpg123_muls[*tab++][m2];
          fraction[0][2][i] = mpg123_muls[*tab][m1]; fraction[1][2][i] = mpg123_muls[*tab][m2];
        }
        scale+=6;
      }
      else {
