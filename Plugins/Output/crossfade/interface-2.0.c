...
create_config_win(void)
{
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(output_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(output_notebook), 0),
				   label31);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(output_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(output_notebook), 1),
				   label32);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(output_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(output_notebook), 2),
				   label33);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(output_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(output_notebook), 3),
				   label34);

	output_help_label =
		gtk_label_new
		("When modifying the Output Options or the Mixing buffer size, you need to stop/restart playback for the settings to take effect.");
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(config_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(config_notebook), 0),
				   config_devices_label);
	...
	gtk_tooltips_set_tip(tooltips, ep_plugin_optionmenu,
			     "Select an effect plugin. Take care not to use the same plugin as selected in XMMS' configuration dialog.",
			     NULL);
	...
	gtk_tooltips_set_tip(tooltips, ep_configure_button, "Open the configuration dialog of the plugin selected above.",
			     NULL);
	...
	gtk_tooltips_set_tip(tooltips, ep_enable_check,
			     "Enable the selected plugin. Note that after pressing 'Apply' it may take a while until you can hear the effect, since it is applied before the audio data goes into the buffer.",
			     NULL);
	...
	gtk_tooltips_set_tip(tooltips, volnorm_target_spin,
	...
	effects_help_label =
		gtk_label_new
		("You do not need to press 'Apply' after making changes to the effect plugin settings. It may take a while though until you can hear the change, since the plugin is applied before the mixing buffer.");
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(config_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(config_notebook), 1),
				   config_effects_label);
	...
	gtk_tooltips_set_tip(tooltips, xf_buffer_spin,
	...
	gtk_tooltips_set_tip(tooltips, xf_config_optionmenu,
	...
	gtk_tooltips_set_tip(tooltips, xf_type_optionmenu,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 0),
				   xft_reopen_label);
	...
	gtk_table_attach(GTK_TABLE(xftf_pause_table), xftfp_length_spin, 1, 2, 1, 2,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xftfp_length_spin,
	...
	gtk_table_attach(GTK_TABLE(xftf_fadein_table), xftffi_volume_spin, 1, 2, 2, 3,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xftffi_volume_spin,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 1),
				   xft_flush_label);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 2),
				   xft_none_label);
	...
	gtk_table_attach(GTK_TABLE(xf_pause_table), pause_length_spin, 1, 2, 0, 1,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, pause_length_spin,
			     "Specify the length of the silence to be inserted between the tracks.\nDefault: 2000", NULL);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 3),
				   xft_pause_label);
	...
	gtk_table_attach(GTK_TABLE(xf_simple_table), simple_length_spin, 1, 2, 0, 1,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, simple_length_spin,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 4),
				   xft_simplexf_label);
	...
	gtk_table_attach(GTK_TABLE(xf_fadeout_table), fadeout_volume_spin, 1, 2, 2, 3,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, fadeout_volume_spin,
	...
	gtk_tooltips_set_tip(tooltips, xfofs_custom_spin,
	...
	gtk_table_attach(GTK_TABLE(xf_offset_table), xfofs_none_radiobutton, 0, 1, 0, 1,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xfofs_none_radiobutton,
			     "Don't overlap the two songs. The next song will start immediatelly after the previous has ended.",
			     NULL);
	...
	gtk_table_attach(GTK_TABLE(xf_fadein_table), fadein_volume_spin, 1, 2, 2, 3,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, fadein_volume_spin,
			     "Set the start volume. XMMS-crossfade will fade from this volume to 100% during the time specified above.\nDefault: 0",
			     NULL);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 5),
				   xft_advancedxf_label);
	...
	gtk_table_attach(GTK_TABLE(xftfi_fadein_table), xftfi_volume_spin, 1, 2, 1, 2,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xftfi_volume_spin,
			     "Set the start volume. XMMS-crossfade will fade from this volume to 100% during the time specified above.\nDefault: 0",
			     NULL);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 6),
				   xft_fadein_label);
	...
	gtk_table_attach(GTK_TABLE(xftfo_fadeout_table), xftfo_volume_spin, 1, 2, 1, 2,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xftfo_volume_spin,
			     "Set the end volume. XMMS-crossfade will fade from 100% to this volume during the time specified above.\nDefault: 0",
			     NULL);
	...
	gtk_table_attach(GTK_TABLE(xftfo_silence_table), xftfo_silence_spin, 1, 2, 0, 1,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xftfo_silence_spin,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 7),
				   xft_fadeout_label);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 8),
				   xft_pause_none_label);
	...
	gtk_table_attach(GTK_TABLE(xft_fadeoutin_table), xftfoi_silence_spin, 1, 2, 1, 2,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, xftfoi_silence_spin,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(xf_type_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(xf_type_notebook), 9),
				   xft_pause_adv_label);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(config_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(config_notebook), 2),
				   config_crossfade_label);
	...
	gtk_table_attach(GTK_TABLE(gap_leading_table), lgap_length_spin, 1, 2, 1, 2,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, lgap_length_spin,
	...
	gtk_table_attach(GTK_TABLE(gap_leading_table), lgap_level_spin, 1, 2, 2, 3,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, lgap_level_spin,
	...
	gtk_table_attach(GTK_TABLE(gap_trailing_table), tgap_length_spin, 1, 2, 1, 2,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, tgap_length_spin,
			     "Set the maximum length for gaps at the end of a stream.\nDefault: 500", NULL);
	...
	gtk_table_attach(GTK_TABLE(gap_trailing_table), tgap_level_spin, 1, 2, 2, 3,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_tooltips_set_tip(tooltips, tgap_level_spin,
	...
	gtk_tooltips_set_tip(tooltips, gadv_crossing_check,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(config_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(config_notebook), 3),
				   config_gapkiller_label);
	...
	gtk_tooltips_set_tip(tooltips, debug_stderr_check,
	...
	gtk_tooltips_set_tip(tooltips, debug_monitor_check,
	...
	gtk_tooltips_set_tip(tooltips, mixopt_software_check,
	...
	gtk_tooltips_set_tip(tooltips, moth_songchange_spin,
	...
	gtk_tooltips_set_tip(tooltips, moth_preload_spin,
	...
	gtk_tooltips_set_tip(tooltips, noxf_album_check,
	...
	gtk_tooltips_set_tip(tooltips, noxf_samefile_check,
	...
	gtk_tooltips_set_tip(tooltips, moth_httpworkaround_check,
	...
	gtk_tooltips_set_tip(tooltips, moth_opmaxused_check,
	...
	gtk_tooltips_set_tip(tooltips, moth_opmaxused_spin,
	...
	gtk_tooltips_set_tip(tooltips, moth_quantaudio_check,
			     "Enable this when you have problems playing internet HTTP audio streams. Unfortunatelly, it also breaks crossfading.\nDefault: Off",
			     NULL);
	...
	gtk_tooltips_set_tip(tooltips, moth_outputkeepopened_check,
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(config_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(config_notebook), 4),
				   config_misc_label);
	...
	gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(presets_list_scrolledwindow), GTK_POLICY_AUTOMATIC,
				       GTK_POLICY_ALWAYS);
	...
	gtk_notebook_set_tab_label(GTK_NOTEBOOK(config_notebook), gtk_notebook_get_nth_page(GTK_NOTEBOOK(config_notebook), 5),
				   config_presets_label);
	...
	g_signal_connect((gpointer) op_configure_button, "clicked",
			 G_CALLBACK(on_output_plugin_configure_button_clicked), NULL);
	g_signal_connect((gpointer) op_about_button, "clicked", G_CALLBACK(on_output_plugin_about_button_clicked), NULL);
	g_signal_connect((gpointer) op_throttle_check, "toggled", G_CALLBACK(on_op_throttle_check_toggled), NULL);
	g_signal_connect((gpointer) op_maxblock_check, "toggled", G_CALLBACK(on_op_maxblock_check_toggled), NULL);
	g_signal_connect((gpointer) op_maxblock_spin, "changed", G_CALLBACK(on_op_maxblock_spin_changed), NULL);
	g_signal_connect((gpointer) op_forcereopen_check, "toggled", G_CALLBACK(on_op_forcereopen_check_toggled), NULL);
	g_signal_connect((gpointer) ep_configure_button, "clicked", G_CALLBACK(on_ep_configure_button_clicked), NULL);
	g_signal_connect((gpointer) ep_about_button, "clicked", G_CALLBACK(on_ep_about_button_clicked), NULL);
	g_signal_connect((gpointer) ep_enable_check, "toggled", G_CALLBACK(on_ep_enable_check_toggled), NULL);
	g_signal_connect((gpointer) volnorm_enable_check, "toggled", G_CALLBACK(on_volnorm_enable_check_toggled), NULL);
	g_signal_connect((gpointer) xf_buffer_spin, "changed", G_CALLBACK(on_xf_buffer_spin_changed), NULL);
	g_signal_connect((gpointer) xf_autobuf_check, "toggled", G_CALLBACK(on_xf_autobuf_check_toggled), NULL);
	g_signal_connect((gpointer) xftfp_length_spin, "changed", G_CALLBACK(on_xftfp_length_spin_changed), NULL);
	g_signal_connect((gpointer) xftfp_enable_check, "toggled", G_CALLBACK(on_xftfp_enable_check_toggled), NULL);
	g_signal_connect((gpointer) xftffi_length_spin, "changed", G_CALLBACK(on_xftffi_length_spin_changed), NULL);
	g_signal_connect((gpointer) xftffi_enable_check, "toggled", G_CALLBACK(on_xftffi_enable_check_toggled), NULL);
	g_signal_connect((gpointer) xftffi_volume_spin, "changed", G_CALLBACK(on_xftffi_volume_spin_changed), NULL);
	g_signal_connect((gpointer) pause_length_spin, "changed", G_CALLBACK(on_pause_length_spin_changed), NULL);
	g_signal_connect((gpointer) simple_length_spin, "changed", G_CALLBACK(on_simple_length_spin_changed), NULL);
	g_signal_connect((gpointer) fadeout_length_spin, "changed", G_CALLBACK(on_fadeout_length_spin_changed), NULL);
	g_signal_connect((gpointer) fadeout_volume_spin, "changed", G_CALLBACK(on_fadeout_volume_spin_changed), NULL);
	g_signal_connect((gpointer) fadeout_enable_check, "toggled", G_CALLBACK(on_fadeout_enable_check_toggled), NULL);
	g_signal_connect((gpointer) xfofs_custom_radiobutton, "toggled", G_CALLBACK(on_xfofs_custom_radiobutton_toggled), NULL);
	g_signal_connect((gpointer) xfofs_custom_radiobutton, "clicked", G_CALLBACK(on_xfofs_custom_radiobutton_clicked), NULL);
	g_signal_connect((gpointer) xfofs_custom_spin, "changed", G_CALLBACK(on_xfofs_custom_spin_changed), NULL);
	g_signal_connect((gpointer) xfofs_none_radiobutton, "clicked", G_CALLBACK(on_xfofs_none_radiobutton_clicked), NULL);
	g_signal_connect((gpointer) xfofs_none_radiobutton, "toggled", G_CALLBACK(on_xfofs_none_radiobutton_toggled), NULL);
	g_signal_connect((gpointer) xfofs_lockout_radiobutton, "toggled",
			 G_CALLBACK(on_xfofs_lockout_radiobutton_toggled), NULL);
	g_signal_connect((gpointer) xfofs_lockout_radiobutton, "clicked",
			 G_CALLBACK(on_xfofs_lockout_radiobutton_clicked), NULL);
	g_signal_connect((gpointer) xfofs_lockin_radiobutton, "toggled", G_CALLBACK(on_xfofs_lockin_radiobutton_toggled), NULL);
	g_signal_connect((gpointer) xfofs_lockin_radiobutton, "clicked", G_CALLBACK(on_xfofs_lockin_radiobutton_clicked), NULL);
	g_signal_connect((gpointer) fadein_length_spin, "changed", G_CALLBACK(on_fadein_length_spin_changed), NULL);
	g_signal_connect((gpointer) fadein_enable_check, "toggled", G_CALLBACK(on_fadein_enable_check_toggled), NULL);
	g_signal_connect((gpointer) fadein_lock_check, "toggled", G_CALLBACK(on_fadein_lock_check_toggled), NULL);
	g_signal_connect((gpointer) fadein_volume_spin, "changed", G_CALLBACK(on_fadein_volume_spin_changed), NULL);
	g_signal_connect((gpointer) xftfi_length_spin, "changed", G_CALLBACK(on_fadein_length_spin_changed), NULL);
	g_signal_connect((gpointer) xftfi_volume_spin, "changed", G_CALLBACK(on_fadein_volume_spin_changed), NULL);
	g_signal_connect((gpointer) xftfo_length_spin, "changed", G_CALLBACK(on_fadeout_length_spin_changed), NULL);
	g_signal_connect((gpointer) xftfo_volume_spin, "changed", G_CALLBACK(on_fadeout_volume_spin_changed), NULL);
	g_signal_connect((gpointer) xftfo_silence_spin, "changed", G_CALLBACK(on_xfofs_custom_spin_changed), NULL);
	g_signal_connect((gpointer) xftfoi_fadeout_spin, "changed", G_CALLBACK(on_fadeout_length_spin_changed), NULL);
	g_signal_connect((gpointer) xftfoi_silence_spin, "changed", G_CALLBACK(on_xfofs_custom_spin_changed), NULL);
	g_signal_connect((gpointer) xftfoi_fadein_spin, "changed", G_CALLBACK(on_fadein_length_spin_changed), NULL);
	g_signal_connect((gpointer) lgap_length_spin, "changed", G_CALLBACK(on_lgap_length_spin_changed), NULL);
	g_signal_connect((gpointer) lgap_level_spin, "changed", G_CALLBACK(on_lgap_level_spin_changed), NULL);
	g_signal_connect((gpointer) lgap_enable_check, "toggled", G_CALLBACK(on_lgap_enable_check_toggled), NULL);
	g_signal_connect((gpointer) tgap_length_spin, "changed", G_CALLBACK(on_tgap_length_spin_changed), NULL);
	g_signal_connect((gpointer) tgap_level_spin, "changed", G_CALLBACK(on_tgap_level_spin_changed), NULL);
	g_signal_connect((gpointer) tgap_lock_check, "toggled", G_CALLBACK(on_tgap_lock_check_toggled), NULL);
	g_signal_connect((gpointer) tgap_enable_check, "toggled", G_CALLBACK(on_tgap_enable_check_toggled), NULL);
	g_signal_connect((gpointer) mixopt_enable_check, "toggled", G_CALLBACK(on_config_mixopt_enable_check_toggled), NULL);
	g_signal_connect((gpointer) moth_songchange_spin, "changed", G_CALLBACK(on_moth_songchange_spin_changed), NULL);
	g_signal_connect((gpointer) moth_opmaxused_check, "toggled", G_CALLBACK(on_moth_opmaxused_check_toggled), NULL);
	g_signal_connect((gpointer) presets_list_list, "click_column", G_CALLBACK(on_presets_list_click_column), NULL);
	g_signal_connect((gpointer) config_ok, "clicked", G_CALLBACK(on_config_ok_clicked), NULL);
	g_signal_connect_swapped((gpointer) config_cancel, "clicked", G_CALLBACK(gtk_widget_destroy), GTK_OBJECT(config_win));
	g_signal_connect((gpointer) config_apply, "clicked", G_CALLBACK(on_config_apply_clicked), NULL);
...
create_monitor_win(void)
{
	...
	g_signal_connect((gpointer) monitor_win, "delete_event", G_CALLBACK(on_monitor_win_delete_event), NULL);
	g_signal_connect((gpointer) monitor_display_drawingarea, "expose_event",
			 G_CALLBACK(on_monitor_display_drawingarea_expose_event), NULL);
...
create_about_win(void)
{
	...
	g_signal_connect_swapped((gpointer) about_ok, "clicked", G_CALLBACK(gtk_widget_destroy), GTK_OBJECT(about_win));
	g_signal_connect_after((gpointer) about_ok, "leave", G_CALLBACK(gtk_widget_hide), NULL);
...
create_help_win(void)
{
	...
	g_signal_connect((gpointer) help_close_button, "clicked", G_CALLBACK(on_help_close_button_clicked), NULL);
